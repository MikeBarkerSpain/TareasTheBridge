...
# directory paths
current_dir = dir(__file__) # se obtiene directamente el directorio del archivo en ejecución (main.py)
...
def get_non_hidden_files_except_current_file(root_dir):
  # Listdir accede a todas las carpetas y archivos que existen (menos los ocultos, que empiezan por '.') 
  # dentro del directorio que se le pasa por argumento

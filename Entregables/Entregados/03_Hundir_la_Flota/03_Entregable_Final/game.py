...
if init_load == 'NG':
    ...
    turn = 1
#Esta es la parte que no funciona. Despues de hacer json.loads el tipo del archivo sigue siendo un string \    por eso luego las otras funciones no funcionan
elif init_load == 'UG':
